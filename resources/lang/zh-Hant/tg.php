...
return [
    ...
    'wtx_no_data'            => '暫無台指資料',
    'wtx_add_btn'            => '➕ 新增台指點位',
    'wtx_add_prompt'         => "➕ 新增台指建倉\n\n請輸入建倉點位（例如：41000）：\n\n輸入「取消」可返回",
    'wtx_invalid_point'      => '❌ 點位請輸入 10000～80000 之間的整數：',
    'wtx_contracts_prompt'   => "建倉點位：:point\n\n請輸入口數（小台，例如：2）：\n\n輸入「取消」可返回",
    'wtx_invalid_contracts'  => '❌ 口數請輸入 1～100 之間的整數：',
    'wtx_position_created'   => "✅ 建倉成功！\n📌 建倉點位：:point\n📦 口數（小台）：:contracts 口",
    'wtx_current_label'      => '當前點位',
    'wtx_diff_points'        => '點差',
    'wtx_diff_amount'        => '損益',
    'wtx_points_unit'        => '點',
