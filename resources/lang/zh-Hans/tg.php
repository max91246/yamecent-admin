...
return [
    ...
    'wtx_no_data'            => '暂无台指资料',
    'wtx_add_btn'            => '➕ 新增台指点位',
    'wtx_add_prompt'         => "➕ 新增台指建仓\n\n请输入建仓点位（例如：41000）：\n\n输入「取消」可返回",
    'wtx_invalid_point'      => '❌ 点位请输入 10000～80000 之间的整数：',
    'wtx_contracts_prompt'   => "建仓点位：:point\n\n请输入口数（小台，例如：2）：\n\n输入「取消」可返回",
    'wtx_invalid_contracts'  => '❌ 口数请输入 1～100 之间的整数：',
    'wtx_position_created'   => "✅ 建仓成功！\n📌 建仓点位：:point\n📦 口数（小台）：:contracts 口",
    'wtx_current_label'      => '当前点位',
    'wtx_diff_points'        => '点差',
    'wtx_diff_amount'        => '损益',
    'wtx_points_unit'        => '点',
