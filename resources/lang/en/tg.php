...
return [
    ...
    'wtx_add_btn'            => '➕ Add Position',
    'wtx_add_prompt'         => "➕ Add TAIEX Position\n\nEnter entry point (e.g. 41000):\n\nType 「取消」 to cancel",
    'wtx_invalid_point'      => '❌ Please enter a valid point between 10000 and 80000:',
    'wtx_contracts_prompt'   => "Entry point: :point\n\nEnter number of contracts (mini, e.g. 2):\n\nType 「取消」 to cancel",
    'wtx_invalid_contracts'  => '❌ Please enter a number between 1 and 100:',
    'wtx_position_created'   => "✅ Position opened!\n📌 Entry: :point\n📦 Contracts (mini): :contracts",
    'wtx_current_label'      => 'Current',
    'wtx_diff_points'        => 'P&L (pts)',
    'wtx_diff_amount'        => 'P&L (NTD)',
    'wtx_points_unit'        => ' pts',
