                            ...
                            <form method="GET" action="" class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{ url('admin/tg-holding/list') }}" class="btn btn-info btn-sm ml-2">當前持股</a>
                                    </div>
                                </div>
                            </form>

                            {{-- 損益摘要 --}}
                            <div class="alert {{ $totalProfit >= 0 ? 'alert-success' : 'alert-danger' }} mb-3">
                                篩選條件下總損益：
                                <strong>{{ $totalProfit >= 0 ? '+' : '' }}NT${{ number_format($totalProfit, 0) }}</strong>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr><td colspan="10" class="text-center">無資料</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
